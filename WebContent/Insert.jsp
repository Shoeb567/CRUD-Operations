...
<br>
<form action="Insert" method="post"><br><center>
<table border="5" style="text-decoration-line: 5 ; line-height: 2.5;border-radius: 25px;padding: 15px;background-color: white">
	<tr style="border:10px solid red;">
		<td colspan="2" style="padding: 20px;color: navy;font-size: 25px;font-style: italic;font-weight: bold;vertical-align: super;font:bold italic; "><center><u>Insert Product</u></td>
	</tr>
	<tr id="tr">
	...
	<tr id="tr">
		<td id="tr" colspan="2"><center><input type="Submit" name="Submit" value="Insert Product" style="background-color: black;border:none;
